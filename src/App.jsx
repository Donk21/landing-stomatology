    ...
    return (
        <header className="sticky top-0 z-40 bg-white/95 backdrop-blur border-b">
            <div className="max-w-6xl mx-auto flex items-center justify-between px-4 h-16">
                <a className="font-semibold text-lg" href="#header">DentalCare</a>
    ...
    const list = [
        {
            ...
            full: "Проводим диагностику, удаляем поражённые ткани, восстанавливаем анатомию зуба светоотверждаемыми материалами. Процедура проходит без боли."
        },
        {
